...
| 👥 Пользователей | 8 |
| 🚀 В production | с сентября 2024 |
| ⏱️ Статус | Активно используется |
...
### Аналитика
*Интерактивные графики анализа рекламаций*

![Аналитика](screenshots/analytics.png)

### ML-прогнозирование
*Прогноз сумм претензий с визуализацией*
...
ReclamationHub/
│
├── 📊 analytics/ # Визуальная аналитика рекламаций
...
- 💡 От идеи до production в одиночку
...
© 2024-2025 Vasilenok Igor. Все права защищены.

Проект является проприетарным и используется для внутренних корпоративных нужд.
