...
**АСУР (Аналитическая система управления рекламациями)** — комплексная система учёта, анализа и прогнозирования рекламаций и претензий. Разработана для оптимизации работы службы качества предприятия. Внутрикорпоративное решение, разработанное по собственной инициативе автора.
...
| Метрика | Значение |
|---------|----------|
| `Рекламаций в базе`<br>`Пользователей`<br>`Production`<br>`Статус` | 1 800+<br>8<br>С сентября 2025<br>Внедрено и активно используется |
...
- **Роль** — автор идеи и full-stack разработчик
- **Период** — июль 2025 по настоящее время
- **Реализация** — cамостоятельно от идеи до production
...
- Проект разработан в инициативном порядке для внутрикорпоративного использования.
- Исходный код является собственностью автора и не публикуется.
- Репозиторий содержит публичное описание для портфолио.
...
### 🔵 Аналитика
*Количественный анализ рекламаций и претензий*

![Аналитика](screenshots/analytic.png)
*Рис. 3 — Страница выбора типа аналитики*

---

![Аналитика](screenshots/analytic_1.png)
![Аналитика](screenshots/analytic_2.png)
*Рис. 4 — Пример количественного анализа*

---

![Аналитика](screenshots/claim_1.png)
*Рис. 5 — Страница с дашбордом претензий*
...
*Рис. 6 — Страница выбора методов прогнозирования*

---

![Прогнозирование](screenshots/forecast_2.png)
*Рис. 7 — Пример результатов прогнозирования претензий*
